...
from src.config import CUSTOM_LLM_BASE_URL, CUSTOM_LLM_API_KEY, CUSTOM_LLM_MODEL
...
def main():
    ...
    print("\n[3/4] CUSTOM LLM MODEL BENCHMARKS")
    print("-" * 40)
    client = OpenAI(base_url=CUSTOM_LLM_BASE_URL, api_key=CUSTOM_LLM_API_KEY, timeout=90.0)

    models_to_test = [
        (CUSTOM_LLM_MODEL, 1500),
    ]
